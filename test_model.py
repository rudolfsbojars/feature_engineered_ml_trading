...
class MLStrategy(bt.Strategy):
    ...
    def next(self):
        ...
        elif prob < self.p.threshold_sell:
            if self.position:
                self.close()
...
if __name__ == "__main__":
    ...
    result = run_backtest(
        data_path="data/spot/all/BTCUSDT-15m-2017-08-2026-03.csv",   #VARIABLE
        model_path="models/BTC_15M/2019-01-01_2020-01-01/full.pkl",   #VARIABLE
        volume_level_file_path="data/spot/volume_levels/BTCUSDT-1m-2017-08-2026-03.parquet",  #VARIABLE

        start_date="2020-01-01", #VARIABLE
        end_date="2020-04-01", #VARIABLE

        warmup=50,
        
        timeframe=15, #VARIABLE
    )
    ...
    path = save_results("models/BTC_15M/2019-01-01_2020-01-01/", final_report)   #VARIABLE